...
@section('content')
  ...
  <section class="food_section layout_padding-bottom">
    ...
    <div class="container">
        ...
        <ul class="filters_menu">
            <li class="{{request()->is('/') ? 'active' : ''}}"><a href="{{ url('menu') }}">All</a></li>
            @foreach ($categories as $category)
                <li class="{{request()->is('select_par_category/'.$category->id) ? 'active' : ''}}" > <a href="{{url('select_par_category', $category->id)}}" 
                    >
                     {{$category->name}}</a> </li>
            @endforeach
        </ul>
        ...
        <div class="filters-content">
            <div class="row grid">
                @foreach ($products as $product)
                    <div class="col-sm-6 col-lg-4 all "> {{-- all burger --}}
