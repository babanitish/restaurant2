                ...
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <p>
                            ...
                            food par le choix multiples des menus gourmands et leur excellent rapport qualité prix.

                            Tout en tenant compte :

                            – La qualité, de l’exigence nutritionnelle et calorique ainsi que la traçabilité des produits,
                            qui plaît au jeunes et aux familles.

                            – Un large choix de viandes, légume et sauces pour composer le menu adéquat au goût de chaque
                            client
                ...
                <div class="owl-carousel client_owl-carousel">
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="detail-box">
                                <p>
                                    le meilleur fast food de tout BX force à vous
                                </p>
                                <h6>
                                    Mike Hamell
                                </h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {{-- {{ $product->id }} --}}
                    <button type="button" id="" class="btn btn-primary addToCart">Ajouter</button>
                </div>
                {{-- @endforeach --}}
            </div>
        </div>
